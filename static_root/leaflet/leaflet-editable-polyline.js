    ...
    _addMethods: function() {
        ...
        this._parseOptions = function(options) {
            ...
            if(options.pointIcon) {
                ...
                this.pointIcon = L.icon({ iconUrl: 'img/editmarker.png', iconSize: [11, 11], iconAnchor: [6, 6], });
            }
            if(options.newPointIcon) {
                this.newPointIcon = options.newPointIcon;
            } else {
                this.newPointIcon = L.icon({ iconUrl: 'img/editmarker2.png', iconSize: [11, 11], iconAnchor: [6, 6], });
            }
        };
